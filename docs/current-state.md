...
suite 1592 passed, 1 skipped sb-free (see stability baseline).*
...
- **Test suite: 1592 passing, 1 skipped sb-free; the pinned-host CI job runs
  ...
  tests on every PR (`1607 passed` = the 1592 sb-free plus the 15 manifest
