---
name: analysis
description: "Read-only deep-dive: investigate and report findings without changing anything."
---

# analysis

Investigate a superbot-idle system and report findings, changing nothing.
